      ...
      <div className="flex-1 flex flex-col h-full">
        ...
        <header className="h-16 bg-white shadow-md flex items-center justify-between px-8 border-b border-slate-200">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-slate-200 to-slate-300 text-slate-500 flex items-center justify-center shadow-inner border border-slate-300 overflow-hidden">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 translate-y-1">
